...
module.exports = {
  ...
  fn: async function({subcategory}){
    ...
    let smallAnimalsProducts = await productSubcategory.pet_product_id;
    let category = await categoryTemp.category_id.category_name;

    return this.res.view(`pages/smallAnimals/smallAnimalsSubcategories`, {smallAnimalsProducts, category, subcategory});
  }
