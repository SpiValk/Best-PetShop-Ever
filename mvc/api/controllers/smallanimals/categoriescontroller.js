...
module.exports = {
  ...
  fn: async function({category}){
    ...
    let smallAnimalsProducts = await productCategory.pet_product_id;



    return this.res.view(`pages/smallAnimals/smallAnimalsCategories`, {smallAnimalsProducts, category, subCategs, subcategories}, {isAdmin: this.req.session.isAdmin});
